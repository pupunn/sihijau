...
<div class="container">
            ...
            <form action="{{ route('sekolah.daftar') }}" method="POST" enctype="multipart/form-data"
                ...
                <table class="table" align="center" cellpadding="10">
                    ...
                    <tr>
                        ...
                        <td class="input-field"><input type="text" id="alamat_sekolah" name="alamat_sekolah"
                                placeholder="" value="{{ old('alamat_sekolah') }}" required
                                autocomplete="alamat_sekolah"></td>
                    </tr>
                    <tr>
                        <td>Nama Operator Sekolah</td>
                        <td class="input-field"><input type="text" id="nama_operator" name="nama_operator"
                                placeholder="" value="{{ old('nama_operator') }}" required autocomplete="nama_operator">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="input-field"><input type="text" id="luas-terbangun" name="luas-terbangun"
                                placeholder="" value="{{ old('') }}"></td>
                        <td><input type="DOCTYPE" id="real-file" hidden="hidden" />
                            <button type="button" id="custom-button">Choose File</button></td>
                    </tr>
                    <tr>
    ...
    <div class="panels-container">
        <div class="panel left-panel">
            ...
            <img src="{{ asset('assets/img/sihijau_logo.png') }}" class="image" alt="" />
        </div>
